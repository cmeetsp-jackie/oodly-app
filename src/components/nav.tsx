...
export function Nav({ user }: NavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 pt-3 pb-6 md:top-0 md:bottom-auto md:border-b md:border-t-0 md:pb-3">
